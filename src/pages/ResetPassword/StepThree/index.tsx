...
const StepThree: React.FC<StepThreeProps> = ({code, document, next}) => {
  ...
  return (
    <>
      <h1 className="text-xl font-bold text-[#2F3367]">{i18n[lang].reset_pass_third_step_title}</h1>
      <p className="mt-3 text-xs w-[55%]">{i18n[lang].reset_pass_third_step_subtitle}</p>
